...
-- Fuentes: standalone-01-bootstrap.sql -> roma-finanzas-access.sql -> standalone-02-auth-bridge.sql -> standalone-03-income-tips.sql -> standalone-04-federated-rservasroma.sql

-- ===== INICIO standalone-01-bootstrap.sql =====
...
commit;
-- ===== FIN standalone-01-bootstrap.sql =====

-- ===== INICIO roma-finanzas-access.sql =====
...
-- ===== INICIO standalone-02-auth-bridge.sql =====
...
commit;
-- ===== FIN standalone-02-auth-bridge.sql =====
...
grant execute on function public.load_roma_finanzas(text) to anon, authenticated;
grant execute on function public.apply_roma_finanzas_change(text, text, jsonb) to anon, authenticated;
grant execute on function public.save_roma_finanzas_income(text, jsonb) to anon, authenticated;
